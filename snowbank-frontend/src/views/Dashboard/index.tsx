...
function Dashboard() {
    ...
    const trimmedStakingAPY = trim(102483.58, 2);
            ...
            <div className="dashboard-infos-wrap">
                <Zoom in={true}>
                    <Grid container spacing={4}>
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                <p className="card-title">{t("STRAT Price")}</p>
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                <p className="card-title">{t("Total Value Locked")}</p>
                                <p className="card-value">
                                    {isAppLoading ? (
                                        <Skeleton width="250px" />
                                    ) : (
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                ...
                                <p className="card-value">{isAppLoading ? <Skeleton width="250px" /> : `${trim(Number(app.currentIndex), 2)} STRAT`}</p>
                            </div>
                        </Grid>
                        ...
                        {/* <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                <p className="card-title">{t("Backing STRAT")}</p>
                                <p className="card-value">
                                    {isAppLoading ? (
                                        <Skeleton width="250px" />
                                    ) : (
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                ...
                                <p className="card-value">{isAppLoading ? <Skeleton width="250px" /> : `${trim(365, 1)} Days`}</p>
                            </div>
                        </Grid>
                    </Grid>
                </Zoom>
