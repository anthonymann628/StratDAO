...
contract sSTRAT is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked StrategyDAO", "sSTRAT", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSTRAT supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSTRAT
